...
public class IntrospectedTableMyBatis3Impl extends IntrospectedTable {
    ...
    protected void calculateJavaModelGenerators(List<String> warnings,
        ...
        if (extendModelPlugin != null) {
            String generatorPo = extendModelPlugin.getProperty("generatorPo");
        ...
        boolean enableVo = false;//生成vo
        if (extendModelPlugin != null) {
            String generatorVo = extendModelPlugin.getProperty("generatorVo");
            if (!StringUtility.stringHasValue(generatorVo) || StringUtility.isTrue(generatorVo)) {
                enableVo = true;
            }
        }
        if (enableVo) {
    ...
    public List<GeneratedJavaFile> getGeneratedJavaFiles() {
        ...
        if (extendModelPlugin != null) {
            String generatorMapper = extendModelPlugin.getProperty("generatorMapper");
    ...
    public List<GeneratedXmlFile> getGeneratedXmlFiles() {
        ...
        if (extendModelPlugin != null) {
            String generatorXml = extendModelPlugin.getProperty("generatorXml");
