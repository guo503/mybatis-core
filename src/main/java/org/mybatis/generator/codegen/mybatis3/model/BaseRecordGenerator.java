...
public class BaseRecordGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        String logicDeletePath = null;
        if (extentModelPlugin != null) {
            idPath = extentModelPlugin.getProperty("id");
            versionPath = extentModelPlugin.getProperty("version");
            logicDeletePath = extentModelPlugin.getProperty("logicDelete");
        }
