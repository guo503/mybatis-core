...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        String generatorMapper = extentModelPlugin.getProperty("generatorMapper");
        ...
        String mapperPath = extentModelPlugin.getProperty("mapper");
        String softDeleteMapperPath = extentModelPlugin.getProperty("softDeleteMapper");
    ...
    private void generateMapper(Interface interfaze, List<CompilationUnit> answer, String domainPojoName, String mapperPath, String mapperPackStr, boolean mapperFileExist) {
        ...
        if (mapperFileExist) {
            ...
            String cond = MethodGeneratorUtils.getCondName(extentModelPlugin, domainPojoName);
